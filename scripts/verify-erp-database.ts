...
const EXPECTED_TABLES = [
  ...
  'lms_assignments',
  'lms_digital_access_codes',
  'lms_digital_attendance',
  'lms_online_payment_submissions',
  'lms_parent_students',
  'lms_parent_portal_credentials',
  'lms_parent_portal_sessions',
  'lms_payment_channels',
...
const EXPECTED_ROLE_LOCK_TRIGGERS = [
  ...
  'lock_lms_digital_access_code_roles',
  'lock_lms_digital_attendance_role',
  'lock_lms_online_payment_roles',
  'lock_lms_parent_credential_role',
  'lock_lms_parent_session_role',
  'lock_lms_payment_channel_role',
