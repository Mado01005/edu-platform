...
- Name: upload-flow.spec.ts >> 📁 Blueprint Nexus — File Upload Flow >> Admin upload page loads with subject/lesson selectors
- Location: e2e/upload-flow.spec.ts:48:7
...
Locator: locator('text=UPLOAD').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=UPLOAD').first()
...
- generic [active] [ref=e1]:
  ...
  - paragraph [ref=e5]: "Error code explanation: HTTPStatus.NOT_FOUND - Nothing matches the given URI."
```
