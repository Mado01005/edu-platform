  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 left-4 md:left-6 z-50 w-12 h-12 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 shadow-[0_0_20px_rgba(6,58,47,0.4)] flex items-center justify-center hover:scale-110 transition-transform border border-white/20"
        title="Study Timer"
      >
