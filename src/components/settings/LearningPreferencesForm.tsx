          ...
          <form className="flex min-w-0 flex-col gap-6" onSubmit={handleSubmit}>
            <fieldset className="min-w-0">
              <legend className="flex items-center gap-2 text-sm font-black">
                <Gauge className="size-4 text-[#052F26]" aria-hidden="true" />
            ...
            <label className="min-w-0 text-sm font-black">
              ...
              <select
                className="mt-2 h-12 w-full min-w-0 rounded-xl border border-slate-300 bg-white px-4 text-sm text-slate-900 outline-none focus:border-[#052F26] focus:ring-2 focus:ring-emerald-100"
                onChange={(event) =>
            ...
            <div className="flex min-w-0 items-start gap-4 rounded-2xl border border-emerald-950/10 bg-[#EEF5F1] p-4">
