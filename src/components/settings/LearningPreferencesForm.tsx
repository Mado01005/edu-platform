          ...
          <form className="flex min-w-0 flex-col gap-6" onSubmit={handleSubmit}>
            <fieldset className="min-w-0">
              <legend className="flex items-center gap-2 text-sm font-black">
                <Gauge className="size-4 text-[#063A2F]" aria-hidden="true" />
            ...
            <div className="flex min-w-0 items-start gap-4 rounded-2xl border border-emerald-950/10 bg-[#F4F7F4] p-4">
