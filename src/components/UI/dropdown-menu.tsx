...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      className={cn('px-2 py-2 text-xs font-medium text-slate-500', className)}
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      className={cn(
        'relative flex cursor-default select-none items-center gap-2 rounded-xl px-2.5 py-2 text-sm font-medium text-slate-700 outline-none transition focus:bg-emerald-50 focus:text-[#052F26] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
        className,
      )}
