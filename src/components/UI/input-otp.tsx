    ...
    >
      {Array.from({ length }, (_, index) => (
        <input
          ...
          className="h-12 min-w-0 rounded-xl border border-slate-300 bg-white text-center font-mono text-lg font-semibold text-slate-900 outline-none transition focus:border-[#063A2F] focus:ring-4 focus:ring-emerald-100 disabled:bg-slate-100 disabled:opacity-70"
          disabled={disabled}
          inputMode="numeric"
          key={index}
          maxLength={1}
