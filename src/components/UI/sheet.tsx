    ...
    <SheetPrimitive.Portal>
      ...
      >
        ...
        <SheetPrimitive.Close
          ...
          className="absolute right-3 top-3 rounded-xl border border-emerald-950/10 bg-white p-2 text-slate-500 transition hover:bg-slate-100 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#052F26]"
        >
