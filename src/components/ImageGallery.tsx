      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        {renderableImages.map((src, i) => (
          <button
            ...
            className="relative w-full h-48 rounded-2xl overflow-hidden bg-white/5 border border-white/10 hover:border-emerald-500/50 hover:shadow-[0_10px_30px_rgba(6,58,47,0.2)] hover:-translate-y-1.5 transition-all duration-500 group cursor-pointer"
