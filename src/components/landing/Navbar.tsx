...
const navigation = [
  { href: '#why-oqool', label: 'Why Oqool', labelArabic: 'لماذا عقول' },
  { href: '#how-it-works', label: 'How it works', labelArabic: 'كيف تعمل' },
  { href: '#curriculum', label: 'Curriculum', labelArabic: 'المناهج' },
  { href: '#outcomes', label: 'Outcomes', labelArabic: 'النتائج' },
] as const;
