...
export function FinalCTASection() {
  return (
    <section className="relative isolate overflow-hidden bg-brand-base px-4 py-20 text-brand-white sm:px-6 md:py-28 lg:px-8">
      <div aria-hidden="true" className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_50%_50%,rgba(178,205,188,0.52),transparent_38%),radial-gradient(circle_at_82%_22%,rgba(216,168,78,0.18),transparent_26%)]" />
