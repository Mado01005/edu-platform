...
export function FinalCTASection() {
  return (
    <section className="relative isolate overflow-hidden bg-brand-base px-4 py-20 text-brand-white sm:px-6 md:py-28 lg:px-8">
      <div aria-hidden="true" className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_50%_50%,rgba(167,194,177,0.16),transparent_38%),radial-gradient(circle_at_82%_22%,rgba(216,166,73,0.18),transparent_26%)]" />
