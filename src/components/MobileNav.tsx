        ...
        <div className="flex justify-around items-center h-16">
          {tabs.map(tab => {
            ...
            return (
              ...
              >
                <div className={`relative ${isActive ? 'drop-shadow-[0_0_8px_rgba(216,166,73,0.6)]' : ''}`}>
                  {tab.icon}
                  {isActive && (
                    <span className="absolute -bottom-1 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-brand-gold shadow-[0_0_6px_rgba(216,166,73,0.8)]"></span>
                  )}
                </div>
