        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-8 bg-[#05050A]/95 backdrop-blur-2xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 relative z-10 w-full justify-center">
            <a
              ...
              className="w-full sm:w-auto px-8 py-3 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 rounded-xl text-xs font-black uppercase tracking-[0.2em] text-emerald-400 transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(5,47,38,0.15)]"
            >
