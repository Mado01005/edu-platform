      ...
      >
        ...
        <div className="flex-1 min-w-0 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-2 md:gap-3 mt-1">
            {hasVideo && (
              <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#052F26]/10 border border-[#052F26]/20 text-xs font-bold text-emerald-400 tracking-wide uppercase shadow-[0_0_10px_rgba(5,47,38,0.1)]">
            ...
            {imageCount > 0 && (
              <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-xs font-bold text-emerald-400 tracking-wide uppercase shadow-[0_0_10px_rgba(34,197,94,0.1)]">
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
