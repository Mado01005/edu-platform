...
export function CoursePriceForm({
  ...
  return (
    ...
    >
      ...
      <ActionSubmitButton className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#084B2B] px-4 py-3 font-bold text-white" pendingLabel="Saving prices…">
