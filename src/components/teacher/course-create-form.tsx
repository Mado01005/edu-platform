    ...
    >
      ...
      <div className="grid min-w-0 grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <label className="min-w-0 text-xs font-bold text-slate-700">
          Subject
          <select
            className="mt-1 w-full min-w-0 rounded-xl border border-slate-300 bg-white px-3 py-3 text-sm text-slate-900 outline-none disabled:bg-slate-100 disabled:text-slate-400 focus:border-[#052F26] focus:ring-2 focus:ring-emerald-100"
            disabled={!gradeLevel}
            name="subjectId"
            required={requireSubject}
          >
      ...
      <input
        className="w-full min-w-0 rounded-xl border border-slate-300 bg-white px-3 py-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-[#052F26] focus:ring-2 focus:ring-emerald-100"
        maxLength={200}
        name="title"
      ...
      />
      <textarea
        className="min-h-24 w-full min-w-0 resize-y rounded-xl border border-slate-300 bg-white px-3 py-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-[#052F26] focus:ring-2 focus:ring-emerald-100"
        maxLength={10_000}
        name="description"
      ...
      <ActionSubmitButton
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#052F26] px-4 py-3 text-sm font-bold text-white hover:bg-[#093F33]"
