  ...
  return (
    <section className="flex w-full min-w-0 flex-col gap-4">
      <form action={action} className="mx-auto flex w-full max-w-md min-w-0 flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <h2 className="flex items-center gap-2 font-black"><Radio className="size-5 text-sky-700" /> Schedule a Zoom session</h2>
        ...
        <ActionSubmitButton className="flex w-full items-center justify-center gap-2 rounded-xl bg-sky-600 px-4 py-3 font-bold text-white hover:bg-sky-700" pendingLabel="Scheduling…"><CalendarPlus className="size-4" /> Schedule class</ActionSubmitButton>
      </form>
