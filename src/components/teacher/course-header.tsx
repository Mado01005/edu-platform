...
export function CourseHeader({ slug, title }: { slug: string; title: string }) {
  ...
  return (
    <header className="flex min-w-0 flex-col gap-3 px-4 pb-3 pt-4 sm:flex-row sm:items-center">
      ...
      <button
        className="flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-bold text-slate-700 transition-colors hover:bg-[#F4F7F4] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#063A2F]"
