    ...
    <section className="min-w-0 rounded-2xl border border-emerald-950/10 bg-white p-4 shadow-sm sm:p-5">
      ...
      <ul className="mt-4 flex min-w-0 flex-col gap-2">
        {materials.map((material) => (
          <li
            className="flex min-w-0 flex-col gap-3 rounded-xl border border-emerald-200/80 bg-emerald-50/70 p-3 text-[#052F26] shadow-sm transition-all hover:border-[#052F26] sm:flex-row sm:items-center sm:justify-between"
            key={material.id}
          >
            <div className="flex min-w-0 items-center gap-3">
              <span className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-[#052F26]">
            ...
            <button
              className="min-h-9 shrink-0 rounded-lg bg-[#052F26] px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-[#093F33] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#052F26] focus-visible:ring-offset-2"
