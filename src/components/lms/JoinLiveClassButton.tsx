...
export function JoinLiveClassButton({ startTime, zoomSessionId }: { startTime: string; zoomSessionId: string }) {
  ...
  return (
    <div className="shrink-0">
      <button className="w-full rounded-xl bg-[#052F26] px-4 py-3 text-center text-sm font-black text-white transition hover:bg-[#093F33] disabled:cursor-not-allowed disabled:bg-slate-300 disabled:text-slate-600" disabled={joining || !enabled} onClick={() => void join()} type="button">
