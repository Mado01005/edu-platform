...
export function R2UploadField({
  ...
  return (
    <div className="flex min-w-0 flex-col gap-2">
      ...
      <label className="flex min-w-0 cursor-pointer items-center gap-3 rounded-xl border border-dashed border-slate-300 bg-[#EEF5F1] p-4 transition hover:border-emerald-400">
