...
function categoryTone(category: AssetCategory) {
  ...
  if (category === 'IMAGE') return 'bg-emerald-50 text-[#052F26]';
    ...
    <>
      ...
      <section className="rounded-3xl border border-emerald-950/10 bg-white p-5 shadow-sm shadow-emerald-950/5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
          <span className="rounded-xl border border-emerald-950/10 bg-[#EEF5F1] p-3 text-slate-600">
      ...
      <section className="flex min-w-0 flex-col gap-3 rounded-3xl border border-emerald-950/10 bg-white p-4 shadow-sm shadow-emerald-950/5">
        ...
        <label className="flex items-center gap-3 rounded-xl border border-emerald-950/10 bg-[#EEF5F1] p-3 text-xs font-black text-slate-700">
          <input
        ...
        <div aria-label="R2 uploads inspection table" role="table">
          ...
          <div className="flex min-w-0 flex-col gap-3">
            {visibleAssets.length ? (
                  ...
                  >
                    <div className="flex min-w-0 items-start gap-3">
                      ...
                      <span className="min-w-0 flex-1" role="cell">
                        <a
                          className="block truncate text-sm font-black text-slate-900 hover:text-[#052F26] hover:underline"
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
                      <span
                        className="rounded-xl border border-emerald-950/10 bg-[#EEF5F1] p-3"
                        role="cell"
                      >
                      ...
                      <span
                        className="col-span-2 rounded-xl border border-emerald-950/10 bg-[#EEF5F1] p-3"
                        role="cell"
                      >
              ...
              <p className="rounded-2xl border border-dashed border-slate-300 bg-[#EEF5F1] p-6 text-center text-sm text-slate-500">
      ...
      >
        <DialogContent>
          ...
          <p className="break-all rounded-xl border border-emerald-950/10 bg-[#EEF5F1] p-3 font-mono text-[11px] leading-5 text-slate-600">
            {deleteTarget?.key}
          </p>
          <DialogFooter>
            <DialogClose asChild>
