      ...
      >
        <div className="flex min-w-0 items-center justify-between gap-4 border-b border-emerald-950/10 px-5 py-4 sm:px-7">
          ...
          <button
            ...
            className="flex size-10 shrink-0 items-center justify-center rounded-xl border border-emerald-950/10 text-slate-500 transition hover:bg-[#EEF5F1] hover:text-slate-900"
            onClick={onClose}
            type="button"
          >
            ✕
        ...
        <div className="space-y-6 p-5 sm:p-7">
          <div className="space-y-2">
            ...
            <div className="flex min-w-0 flex-col gap-2 sm:flex-row">
              <input
                className="min-w-0 flex-1 rounded-xl border border-slate-300 bg-white px-4 py-3 font-semibold text-slate-900 outline-none focus:border-[#052F26] focus:ring-2 focus:ring-emerald-100"
                id="activity-streak"
                min="0"
              ...
              />
              <button
                className="rounded-xl bg-[#052F26] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#093F33] disabled:opacity-50"
                disabled={isSaving}
          ...
          <div className="space-y-2">
            ...
            <textarea
              className="min-h-32 w-full resize-y rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-[#052F26] focus:ring-2 focus:ring-emerald-100"
              id="admin-notes"
            ...
            />
            <button
              className="w-full rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-bold text-[#052F26] transition hover:bg-emerald-100 disabled:opacity-50"
              disabled={isSaving}
          ...
          <div className="space-y-2 rounded-2xl border border-emerald-950/10 bg-[#EEF5F1] p-4">
          ...
          {message ? (
            <p aria-live="polite" className="text-center text-sm font-bold text-[#052F26]">
              {message}
            </p>
          ) : null}
        </div>
