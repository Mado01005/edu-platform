...
export function CurriculumBulkManager({
  ...
  return (
    <>
      ...
      <label className="flex items-center gap-3 rounded-2xl border border-emerald-950/10 bg-[#EEF5F1] p-4 text-sm font-black text-slate-800">
        <input
          checked={allSelected}
      ...
      <section className="flex min-w-0 flex-col gap-4">
        <div className="rounded-2xl border border-emerald-950/10 bg-white p-5 shadow-sm">
          <h2 className="flex items-center gap-2 text-lg font-bold text-slate-900">
            <BookOpenCheck className="size-5 text-[#052F26]" aria-hidden="true" />
            Subjects
          </h2>
          <ul className="mt-4 flex flex-col gap-2">
            ...
            {!subjects.length ? (
              <li className="rounded-xl border border-dashed border-slate-300 bg-[#EEF5F1] p-5 text-center text-sm text-slate-600">
              ...
              return (
                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    />
                    <Link
                      className="min-w-0 flex-1 truncate text-sm font-black text-slate-900 hover:text-[#052F26]"
                  ...
                  {course.modules.length ? (
                    <ul className="mt-3 flex flex-col gap-2 border-l-2 border-slate-100 pl-4">
                      {course.modules.map((courseModule) => {
                        ...
                        return (
                          <li
                            className="flex min-w-0 items-center gap-3 rounded-lg bg-[#EEF5F1] p-2.5"
                            key={courseModule.id}
                          >
                            <input
