  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-4">
      <section className="grid min-w-0 grid-cols-3 gap-2" aria-label="Radar metrics">
        {[
          { badge: 'bg-emerald-50', icon: Activity, label: 'Active', tone: 'text-[#052F26]', value: totalStudents },
          { badge: 'border border-[#D8A649]/40 bg-[#EEF5F1]', icon: CheckCircle2, label: 'Healthy', tone: 'text-[#805C1D]', value: healthyCount },
      ...
      >
        ...
        <div className="grid min-w-0 grid-cols-2 gap-2">
          <select
            ...
            className="h-11 min-w-0 rounded-xl border border-emerald-950/10 bg-white px-3 text-sm font-bold text-slate-900 outline-none focus:border-[#052F26] focus:ring-4 focus:ring-emerald-100"
      ...
      <section className="flex min-w-0 flex-col gap-3" aria-label="Student engagement radar">
          ...
          >
            ...
            <div className="mt-4 grid min-w-0 grid-cols-3 gap-2 text-center">
              {[
                ...
                <div className="min-w-0 rounded-xl border border-emerald-950/10 bg-[#EEF5F1] p-2" key={label}>
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              <Button
                className="border-emerald-200 bg-emerald-50 text-[#052F26] hover:bg-emerald-100"
                onClick={() => setEditingStudent(student)}
                size="sm"
                type="button"
                variant="outline"
        ...
        {!filteredCount ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-[#EEF5F1] p-8 text-center text-sm text-slate-600">
