  ...
  return (
    <>
      <section className="flex min-w-0 flex-col gap-4 rounded-2xl border border-emerald-950/10 bg-white p-5 shadow-sm shadow-emerald-950/5 sm:flex-row sm:items-center sm:p-6">
        <span className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-emerald-100 text-[#063A2F]">
          <ClipboardCheck aria-hidden="true" className="size-5" />
        </span>
        <div className="min-w-0 flex-1">
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#063A2F]">
        ...
        <Link
          className="flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl bg-[#063A2F] px-4 text-sm font-bold text-white shadow-sm transition-all duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#0A4235] hover:shadow-md"
