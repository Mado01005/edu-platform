    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-10 fade-in">
          <p className="text-indigo-400 text-sm font-medium mb-2">Welcome back, {user?.name} 👋</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-10">
          ...
          <div className="glass-card rounded-xl px-5 py-4 hidden sm:block">
            <p className="text-2xl font-bold text-white">
              {subjects.reduce((acc, s) => acc + s.lessons.filter((l) => l.video).length, 0)}
            </p>
        ...
        {subjects.length === 0 ? (
          <div className="text-center py-20 text-gray-500">
            ...
            <p className="text-sm mt-2">Add folders inside the <code className="bg-white/5 px-1 rounded">/content</code> directory to get started.</p>
          </div>
        ) : (
