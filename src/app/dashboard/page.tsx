...
export default async function DashboardPage({
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-[#F4F7F4] text-slate-900">
      <DashboardLogger />
      <div>
      <Navbar
      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
        ...
        {globalMsg?.message && (
          <div className="mb-8 flex items-start gap-4 rounded-2xl border border-emerald-200 bg-emerald-50 p-4 shadow-sm fade-in">
            <div className="mt-0.5 shrink-0 rounded-xl bg-emerald-100 p-2">
              <svg className="h-5 w-5 text-[#063A2F]" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"/></svg>
            </div>
        ...
        <div className="mb-10 mt-4 fade-in">
          <p className="mb-3 flex min-w-0 flex-wrap items-center gap-3 text-sm font-semibold text-[#063A2F]">
            <span className="h-2 w-2 rounded-full bg-[#063A2F]"></span>
        ...
        <a href="/profile" className="block mb-10 fade-in scale-in group" style={{ animationDelay: '0.15s' }}>
          <div className="card-hover flex min-w-0 items-center justify-between gap-4 rounded-2xl border border-emerald-950/10 bg-white p-5 shadow-sm shadow-emerald-950/5">
            <div className="flex min-w-0 items-center gap-4">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-100 text-[#063A2F]">
            ...
            <svg className="h-5 w-5 shrink-0 text-slate-400 transition group-hover:translate-x-1 group-hover:text-[#063A2F]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mb-14 fade-in scale-in" style={{ animationDelay: '0.2s' }}>
           <div className="mb-6 flex min-w-0 items-center justify-between gap-4">
              ...
              <span className="shrink-0 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-[10px] font-semibold uppercase tracking-wider text-[#063A2F]">Achievements</span>
           </div>
           <BadgeGallery />
        </div>
        ...
        {subjects.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white py-20 text-center text-slate-500">
            ...
            <p className="text-sm mt-2">
              Courses are currently syncing or none have been added yet. Use the <strong className="text-[#063A2F]">Admin Panel</strong> to create course folders.
            </p>
            <div className="mt-8 inline-block rounded-xl bg-[#F4F7F4] p-4 text-left text-xs text-slate-500">
